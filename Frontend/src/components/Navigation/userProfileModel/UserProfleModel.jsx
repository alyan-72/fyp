...
function UserProfileModel({ isModelOpen, toggleModel, onLogout, onProfile }) {
    ...
    return (
        <div className="relative inline-block" ref={modalRef}>
            <button className="p-0 bg-transparent cursor-pointer" onClick={() => toggleModel(!isModelOpen)}>
                <img src={profilePhoto} alt="Avatar" className="w-10 h-10 object-cover rounded-full" />
            </button>
            ...
            {isModelOpen && (
                <div className="absolute left-0 z-10 mb-2 w-40 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 bottom-full">
                    <div className="py-2" role="menu" aria-orientation="vertical">
                        ...
                        <button
                            onClick={onProfile}
                            className="flex items-center w-full text-left px-4 py-2 text-md text-gray-700 hover:bg-gray-100 mb-2 bg-white"
                            role="menuitem"
                        >
                            <img
                                src={profile}
                        ...
                        <button
                            onClick={onLogout}
                            className="flex items-center w-full text-left px-4 py-2 text-md text-gray-700 hover:bg-gray-100 bg-white"
                            role="menuitem"
                        >
